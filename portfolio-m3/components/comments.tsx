  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2">
        {/* Replacing <img> with <Image> from Next.js */}
...
export function MarqueeDemo() {
  return (
    <div className="relative flex h-[250px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
